...
import com.mobixell.xtt.util.DummySSLSocketFactory;
import com.mobixell.xtt.util.GreenMailUtil;
import com.mobixell.xtt.util.ServerSetup;
import com.mobixell.xtt.util.ServerSetupTest;

/**
 * @author Wael Chatila
 * @version $Id: GreenMailUtil.java,v 1.1 2010/05/14 13:00:46 awadhai Exp $
 * @since Jan 29, 2006
 */
public class GreenMailUtil {
    ...
    public static Session getSession(final ServerSetup setup) {
        ...
        if(setup.getBindAddress() != null)
        {
        	props.setProperty("mail.smtp.host", setup.getBindAddress());	
        }
