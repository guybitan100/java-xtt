 ...
 * lines of text.
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.2 2006/07/21 17:04:31 cvsbuild Exp $
 */
public class TextAreaPainter extends JComponent implements TabExpander
{
	private static final long serialVersionUID = 1L;
	public static final String tantau_sccsid = "@(#)$Id: TextAreaPainter.java,v 1.2 2006/07/21 17:04:31 cvsbuild Exp $";
    /**
    ...
    {
        super.setFont(font);
        //fm = Toolkit.getDefaultToolkit().getFontMetrics(font); // DEPRECATED // rsoder
        fm = XTTProperties.getXTTGui().getFontMetrics(font);
    ...
    {
        invalidateLineRange(
            textArea.getSelectionStartLine(),
    ...
    protected void paintCaret(Graphics gfx, int line, int y)
    {
        if (textArea.isCaretVisible())
        {
            ...
            int caretWidth =
                ((blockCaret || textArea.isOverwriteEnabled()) ? fm.charWidth('w') : 1);
            y += fm.getLeading() + fm.getMaxDescent();
            int height = fm.getHeight();
            gfx.setColor(caretColor);
            if (textArea.isOverwriteEnabled())
            {
                int caretY = y + height - 1;
