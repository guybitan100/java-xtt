...
import com.mobixell.xtt.log.SearchTaDialog;
 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.3 2007/01/18 15:16:33 rsoder Exp $
 */
public class JEditTextArea extends JComponent
{
	private static final long serialVersionUID = -5560403623775809799L;
	public static final String tantau_sccsid = "@(#)$Id: JEditTextArea.java,v 1.3 2007/01/18 15:16:33 rsoder Exp $";
	LogViewer lv;
    /**
	...
	public JEditTextArea(ConfigurationEditor ce) {
		this(TextAreaDefaults.getDefaults());
		this.ce = ce;
	}

	public JEditTextArea(TextAreaDefaults defaults, LogViewer lv) {
		this(defaults);
		this.lv = lv;
	}
    /**
    ...
    public JEditTextArea(TextAreaDefaults defaults)
    {
        ...
        painter.setFont(new Font(Font.SERIF, Font.PLAIN, 16));
        addFocusListener(new FocusHandler());

        // Added by rsoder 2005/07/08.//////////////////////////////////////////////////////////////
        ...
        // REPLACE DEPRECATED isManagingFocus /// rsoder////////////////////////////////////////////
        java.util.HashSet<AWTKeyStroke> set=new java.util.HashSet<AWTKeyStroke>();
        set.add(AWTKeyStroke.getAWTKeyStroke(java.awt.event.KeyEvent.VK_TAB,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        setFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS,set);

        set=new java.util.HashSet<AWTKeyStroke>();
        set.add(AWTKeyStroke.getAWTKeyStroke(java.awt.event.KeyEvent.VK_TAB,java.awt.event.InputEvent.CTRL_DOWN_MASK+java.awt.event.InputEvent.SHIFT_DOWN_MASK));
    ...
    public void paste()
    {
        if(editable)
        {
            ...
            try
            {
                ...
                // Do this for Windows or the Mac patch wont work propperly // rsoder 2006/07/06 ////////// 
            ...
            catch(Exception e)
            {
                getToolkit().beep();
                // rsoder 2006/07/06 ////////// 
                com.mobixell.xtt.XTTProperties.printWarn("Clipboard does not contain a String!");
                if(com.mobixell.xtt.XTTProperties.printDebug(null))
                {
                    com.mobixell.xtt.XTTProperties.printException(e);
                }
    ...
    public void processKeyEvent(KeyEvent evt)
    {
        ...
        case KeyEvent.KEY_PRESSED:
            // Copy/Paste/Cut added by rsoder 2007/01/18.//////////////////////////////////////////////////////////////
            if((evt.getModifiers()&KeyEvent.CTRL_MASK)!=0&&evt.getKeyCode()==KeyEvent.VK_C)
            {
                copy();
                evt.consume();
            } else if((evt.getModifiers()&KeyEvent.CTRL_MASK)!=0&&evt.getKeyCode()==KeyEvent.VK_X)
            {
                cut();
                evt.consume();
            } else if((evt.getModifiers()&KeyEvent.CTRL_MASK)!=0&&evt.getKeyCode()==KeyEvent.VK_V)
            {
                paste();
                evt.consume();
            } 
            else if((evt.getModifiers()&KeyEvent.CTRL_MASK)!=0&&evt.getKeyCode()==KeyEvent.VK_F) 
    		{
    			 search();
    		}
            else
	...
	{
	if (sd==null && lv!=null) 
		sd = new SearchTaDialog(lv);
	else if (sd==null && ce!=null) 
		sd = new SearchTaDialog(ce);
	else 
		sd.setVisible(true);
	sd.requestFocus();
	}
    ...
    private class CaretBlinker implements ActionListener
    {
    ...
    class MouseHandler extends MouseAdapter
    {
        ...
        private void doQuadroClick()
        {
            select(0,document.getLength()-1);
        }
    }
...
/*
    ...
    */
    ...
    private class WheelListener implements MouseWheelListener
    {
        ...
        {
            int currentVal=vertical.getValue();
            int nextVal=currentVal+e.getScrollAmount()*e.getWheelRotation()*vertical.getUnitIncrement(e.getWheelRotation());
            if(nextVal<vertical.getMinimum())nextVal=vertical.getMinimum();
            if(nextVal>vertical.getMaximum())nextVal=vertical.getMaximum();
            vertical.setValue(nextVal);
        }
    }
}
