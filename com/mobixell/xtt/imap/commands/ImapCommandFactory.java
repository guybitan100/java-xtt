...
public class ImapCommandFactory {
    ...
    public ImapCommandFactory() {
        ...
        _imapCommands.put(StarttlsCommand.NAME, StarttlsCommand.class); // added by anil w.
...
//        _imapCommands.put( "MYRIGHTS", MyRightsCommand.class );
        ...
        // quota related
        _imapCommands.put(SetQuotaCammand.NAME, SetQuotaCammand.class);
        _imapCommands.put(GetQuotaCammand.NAME, GetQuotaCammand.class);
        _imapCommands.put(GetQuotaRootCommand.NAME, GetQuotaRootCommand.class);
        
        // its not command just for creating user at server
        _imapCommands.put(CreateUserCommand.NAME, CreateUserCommand.class);
    }
