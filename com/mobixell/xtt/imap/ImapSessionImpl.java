...
import com.mobixell.xtt.IMAPWorker;
...
public final class ImapSessionImpl implements ImapSession {
    ...
    public ImapSessionImpl(ImapHostManager imapHost,UserManager users,IMAPWorker worker,String clientHostName,String clientAddress)
    {
         this.imapHost = imapHost;
         this.users = users;
         this.worker = worker;
    ...
    //    handler.resetHandler(); // ImapHandler is no more with us ;-)
        worker.resetWorker();
    }
