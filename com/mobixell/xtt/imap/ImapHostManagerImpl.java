 ...
 * the {@link com.mobixell.xtt.store.InMemoryStore} implementation of {@link com.mobixell.xtt.store.Store}.
...
public class ImapHostManagerImpl
    ...
    //TODO: added by anil   
    public void setQuota(GreenMailUser user, String folderName, long quotasize) throws FolderException {
        
          MailFolder existingFolder = getFolder(user, folderName, true);
          existingFolder.setQuota(quotasize);
    }
     ...
     *
     * @see com.mobixell.xtt.imap.ImapHostManager#listMailboxes
     */
    @SuppressWarnings("unchecked")
    private Collection listMailboxes(GreenMailUser user,
        ...
        ArrayList<Object> mailboxes = new ArrayList<Object>();
