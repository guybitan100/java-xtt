...
import com.mobixell.xtt.imap.ImapConstants;
...
import com.mobixell.xtt.store.Store;
...
public class InMemoryStore
    ...
    /**
     * @see com.mobixell.xtt.store.Store#listMailboxes
     */
    ...
    @SuppressWarnings("unchecked")
    private void addAllChildren(HierarchicalFolder mailbox, Collection<HierarchicalFolder> mailboxes) {
    ...
    private class HierarchicalFolder implements MailFolder {
        ...
        public long appendMessage(MimeMessage message,
          ...
          //check for space
            ...
            {
                XTTProperties.printFail("got MessagingException");  
            }
            if (this.maxquota != 0 && this.maxquota < (msgsize+this.currentUsage) )
            {
                XTTProperties.printFail("QUOTA IS FULL");
                return uid;
            }
            nextUid++;
...
//            flags.setRecent(true);
            ...
            System.out.println("class in append :"+this.getClass().hashCode());
                currentUsage =  currentUsage +msgsize;
                System.out.println("currentUsage :"+currentUsage);
        ...
        public long getQuotaRoot(String foldername) {
            // TODO Auto-generated method stub
            return 0;
        }
       
      
        public long setQuota(long size) {
            // TODO Auto-generated method stub
            this.maxquota = size;
            return maxquota;
        }
            ...
            System.out.println("class getCurrentUsage :"+this.getClass().hashCode());
            System.out.println("this. currentUsage "+this.currentUsage);
            System.out.println(" currentUsage "+currentUsage);
            return currentUsage;
        }
