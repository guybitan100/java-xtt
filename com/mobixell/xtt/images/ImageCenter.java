 ...
 */
package com.mobixell.xtt.images;
 ...
 * 
 * User: GuyBitan Date: Jan 14, 2008
 */
public class ImageCenter 
{
	...
	public static final String ICON_XML = "xmldoc.gif";
	...
	public static final String ICON_DELETE_ALL = "delete_obj_big.gif";
	
	public static final String ICON_DELETE_ITEM = "delete_obj_small.gif";

	public static final String ICON_IGNORE_MSG = "ignore_message.gif";
	
	public static final String ICON_EXIT = "exit.gif";

	public static final String ICON_XTT_TEST = "import.gif";
	
	public static final String ICON_SUBTEST = "subtest.gif";

	public static final String ICON_PUBLISH = "publish.gif";

	public static final String ICON_OPEN_TYPE = "opentype.gif";
	
	public static final String ICON_STEP_EXCEPTION = "stepException.gif"; 

	public static final String ICON_STEP_NOT_RUNNING = "stepNotRunning.gif";
	
	public static final String ICON_STEP_MANDATORY_NOT_RUNNING = "stepMandatoryNotRunning.gif";
	...
	public static final String ICON_AUTO_SAVE = "auto_save.gif";

	public static final String ICON_CLEAR = "clear.gif";

	public static final String ICON_XTT_GREEN = "debug.png";
	
	public static final String ICON_XTT_RED = "debugred.png";
	...
	public static final String ICON_STEP_FAILER = "stepfail.gif";

	public static final String ICON_STEP_RUN = "steprun.gif";
	
	public static final String ICON_STEP_OK = "stepok.gif";
	...
	public static final String ICON_THREAD = "threadNRunning.gif";
	...
	public static final String ICON_TABLE_HEADER_THREAD = "tableTitleThread.gif";
	...
	public static final String ICON_BLANK = "background-blank.png";
	...
	public static final String ICON_ARROW_RIGHT_YELLOW = "nav_forward.gif";
	
	public static final String ICON_ARROW_RIGHT_PINK = "nav_forward_pink.gif";
	
	public static final String ICON_ARROW_RIGHT_RED = "nav_forward_red.gif";
	
	public static final String ICON_ARROW_RIGHT_GREEN = "nav_forward_green.gif";
	
	public static final String ICON_ARROW_RIGHT_BLUE = "nav_forward_blue.gif";
	...
	public static final String ICON_COPY_TESTS = "copyTests.gif";
	
	public static final String ICON_COPY_FOLDER = "open-test.gif";
	
	public static final String MENU_ICON_DUPLICATE_STEP = "duplicateStep.gif";
	
	public static final String MENU_ICON_PASTE_TESTS = "pasteTests.gif";
	
	private static final String[] iconList = { ICON_EMPTY, ICON_BLUE, ICON_GREEN, ICON_RED,ICON_PASTE,
			ICON_SMALL_OK, ICON_SMALL_ERROR, ICON_RUN, ICON_STOP, ICON_PAUSE, ICON_REFRESH, ICON_NEW,
			ICON_JAR, ICON_TEST_PASS, ICON_TEST_FAIL, ICON_PATH, ICON_DIR, ICON_TEST_CASE, ICON_UP, ICON_DOWN, ICON_TO_TOP, ICON_TO_BOTTOM,
			ICON_R_PASS, ICON_R_FAIL, ICON_R_WARNING, ICON_REFRESH_REPORTS, ICON_SAVE, ICON_IGNORE, ICON_DELETE_ALL,ICON_DELETE_ITEM,
			ICON_IGNORE_MSG, ICON_XTT_TEST, ICON_XTT_TEST, ICON_PUBLISH, ICON_OPEN_TYPE,ICON_SEARCH, ICON_STEP_NOT_RUNNING, ICON_CHANGE_TESTS_DIR,
			ICON_FILTER_SUCCESS, ICON_FILTER_TESTS_TREE,ICON_SORT_TESTS_TREE, ICON_EDIT, ICON_VIEW_PROCESSED_SUT,
			ICON_ADD, ICON_SAVE_AS,ICON_AUTO_SAVE, ICON_CLEAR, ICON_XTT_GREEN,ICON_XTT_RED,ICON_TABLE_HEADER_THREAD,ICON_SUBTEST,
			ICON_CODE, ICON_CHANGE_SUT, ICON_GRAPH, ICON_EDIT_SCENARIO, ICON_SUSPEND,ICON_ARROW_RIGHT_PINK,ICON_COPY_FOLDER,
			ICON_ARROW_RIGHT_RED,ICON_ARROW_RIGHT_GREEN,ICON_ARROW_RIGHT_BLUE,ICON_STEP_EXCEPTION,ICON_STEP_MANDATORY_NOT_RUNNING,
			ICON_SELECT_SCENARIO, ICON_TEST, ICON_TEST_ERR, ICON_STEP_FAILER, ICON_STEP_OK, ICON_STEP_RUN,
			ICON_SCENARIO, ICON_SCENARIO_ERROR, ICON_SCENARIO_FAIL, ICON_SCENARIO_OK, ICON_SCENARIO_RUN,ICON_XML,
			ICON_SCENARIO_NEW, ICON_EXPORT_WIZ, ICON_IMPORT_WIZ, ICON_SO_GEN, ICON_JSYSTEM, ICON_SUT, ICON_SUT_FAILED,
			ICON_SUT_PASSED, ICON_SUT_RUNNING, ICON_SUT_EDIT, ICON_SUT_SAVE, ICON_SUT_ERROR, ICON_THREAD, ICON_RUN_TOOLBAR_BG,
			ICON_TABBES_TOOLBAR_BG,ICON_EXIT, ICON_REPORT_FAIL, ICON_REPORT_PASS, ICON_TOP_TOOLBAR_BG, ICON_SCEANRIO_TOOLBAR_BG,
			ICON_BUTTON_BG, ABOUT_DIALOG_LEFT_IMAGE, ICON_TABLE_HEADER, ABOUT_DIALOG_LOGO, ICON_CURRENT_FIXTURE,
			ICON_ERROR, ICON_TEST_TREE_BG, ICON_FIXTURE_FAILD, ICON_FIXTURE_PASSED, ICON_FIXTURE_RUNNING,MENU_ICON_DUPLICATE_STEP,
			...
			ICON_DEVICE_PROPERTY_OPTIONAL,ICON_SCRIPT_RUN, ICON_SCRIPT_OK, ICON_SCRIPT_ERR,ICON_BLANK,
			...
			ICON_SCENARIO_AS_TEST,ICON_SCENARIO_AS_TEST_RUN,ICON_SCENARIO_AS_TEST_PASS,ICON_SCENARIO_AS_TEST_FAIL,ICON_SCENARIO_AS_TEST_WARNING, ICON_SCENARIO_AS_TEST_ERROR,ICON_ARROW_RIGHT_RED,ICON_ARROW_RIGHT_YELLOW, ICON_NAV_BACKWARD,
			...
			MENU_ICON_NEGETIVE,MENU_ICON_KNOWN_ISSUE,MENU_ICON_CANCEL_KNOWN_ISSUE,MENU_ICON_CANCEL_NEGETIVE,ICON_UNCHECK,MENU_ICON_CUT_TESTS,ICON_COPY_TESTS,MENU_ICON_PASTE_TESTS};

	private static ImageCenter imageCenter = null;

	private static final String IMAGE_DIR = "com/mobixell/xtt/images/";
