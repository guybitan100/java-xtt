 ...
 * RTSPContent
 * <p>
 * Create contents for the RTSP classes
 */
public class RTSPContent implements RTSPConstants
{
    ...
    public static byte[] createNotify(LinkedHashMap<String,Vector<String>> receivedHeader, String mode, String serverAddress, int serverPort) throws IOException
    {
        ...
        outputStream.write(ConvertLib.createBytes("NOTIFY "+toUrl[1]+" RTSP/2.0\r\n"));
        ...
        v=new Vector<String>();
        //Via: RTSP/2.0/TCP 172.20.14.1:59189;branch=z9hG4bK6d84307ebf9535053c41670c6303d2ad
        v.add("RTSP/2.0/"+mode+" "+serverAddress+":"+serverPort+";branch=12334456754");
        ...
        if(contentType!=null&&contentType.equals("application/pidf+xml"))
        {
            body=ConvertLib.createBytes("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n"
                                       ...
                                       +"      <basic>open</basic>\r\n"
                                       +"    </status>\r\n"
                                       +"    <contact priority=\"0.8\">rtsp:"+fromUrl[1]+"</contact>\r\n"
                                       +"  </tuple>\r\n"
                                       +"</presence>\r\n");
        }
        v=new Vector<String>();
        ...
        String debug=RTSPWorker.printDeepHeaders(mode,sendHeader,outputStream);
